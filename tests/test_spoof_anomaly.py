...
from beam_check_config import SAMPLES_PER_SECOND, EXP_TMIT_MIN, NUM_NANOSEC_IN_1_SEC
    ...
    def __call__(self):
        ...
        while i < self.n_emits:
            ...
            pvs = {
                k: v.emit_readings(
                    start_time,
                    start_time + self.emit_period * NUM_NANOSEC_IN_1_SEC,
            ...
            iteration += 1
            i += 1
            start_time += NUM_NANOSEC_IN_1_SEC
            yield emission
